...
client.on('data', function(data){
	...
	stats.dtot.TotalShares = stats.dtot.Accepted+stats.dtot.Rejected;
	//End stats.dtot
	...
	console.log(stats.pi);
	//End stats.pi
	stats.minerUp = true;
	stats.minerDown = false;
	stats.uptime = stats.pi.uptime;
	stats.time = Math.floor((new Date()-0)/1000);
